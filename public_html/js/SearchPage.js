...
$('#user-welcome').hide();
  ...
  console.log("Your username is "+getCookie("searchKey"));
        $.getJSON("http://localhost:8383/Services/webresources/booksnew/getSearchDetails/"+getCookie("searchKey"), function(result){
